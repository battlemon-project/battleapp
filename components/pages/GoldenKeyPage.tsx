    ...
    <div className="container mt-1" style={{minHeight: 'calc(100vh - 250px)'}}>
      ...
      <div className="row">
        ...
        <div className="col-12 col-md-7">
          ...
          <div className={cn('p-3 py-4 rounded-4 mb-2', shopStyles.lightBg)}>
            ...
            <div className="d-flex justify-content-between mb-2">
              <b>Timer ends</b>
              <div style={{fontSize: '18px'}}>FINISHED</div>
            </div>
            <div className="d-flex justify-content-between mb-2">
          ...
          <p className="rounded-3 mb-4 mt-4" style={{borderLeft: '5px solid rgba(255,255,255,0.4)', background: 'rgba(255,255,255,0.1)', padding: '8px 15px', fontSize: '15px'}}>
