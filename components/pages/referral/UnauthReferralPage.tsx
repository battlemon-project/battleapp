...
export default function UnauthReferralPage({ isSupportedChain }: { isSupportedChain: boolean }) {
  ...
  return (
    <div className="container mt-1" style={{minHeight: 'calc(100vh - 250px)'}}>
      ...
      <div className="row">
        ...
        <div className={cn('col-lg-7 col-12 position-relative mt-5 pt-5')}>
          {isSupportedChain ? <SignInButton /> : <>
