...
export default function BattlemonLoader() {
  return (
    <div style={{left: '50%', transform: 'translateX(-50%)'}} className="bg-black h-100 vw-100 position-fixed top-0 left-0 d-flex align-items-center justify-content-center">
